...
namespace ObsidianGameplayTags
{
	...
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Montage_Melee_Weapon)
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Montage_Melee_RightHand)
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Montage_Melee_LeftHand)
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Montage_Melee_BetweenHands)
