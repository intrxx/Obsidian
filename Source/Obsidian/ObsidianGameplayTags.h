...
namespace ObsidianGameplayTags
{
	...
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Belt);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Gloves);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Boots);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Shield);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Quiver);
	
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Amulet);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Ring);
	
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Dagger);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Wand);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Flail);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Bow_TwoHand); 
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Staff_TwoHand);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Mace_OneHand);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Mace_TwoHand);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Category_Sword_OneHand);
	...
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Equipment_SwapSlot_Weapon_RightHand);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Equipment_SwapSlot_Weapon_LeftHand);
	...
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Equipment_Slot_Belt);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Equipment_Slot_Gloves);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Equipment_Slot_Boots);
