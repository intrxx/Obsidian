...
namespace ObsidianGameplayTags
{
	...
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Affix_SkillImplicits_Defence_HealthRegeneration);
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Affix_SkillImplicits_Defence_ManaRegeneration);
