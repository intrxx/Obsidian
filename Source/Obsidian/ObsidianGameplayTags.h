...
namespace ObsidianGameplayTags
{
	...
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Montage_Socket_RightHandWeapon)
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Montage_Socket_LeftHandWeapon)
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Montage_Socket_RightHand)
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Montage_Socket_LeftHand)
	OBSIDIAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Montage_Socket_BetweenHands)
