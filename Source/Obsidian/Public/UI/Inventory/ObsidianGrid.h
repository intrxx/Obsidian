...
public:
	void ConstructGrid(UObsidianInventoryWidgetController* InOwningWidgetController, const int32 GridWidth, const int32 GridHeight);
...
protected:
	...
	UPROPERTY()
	TWeakObjectPtr<UObsidianInventoryWidgetController> OwningWidgetController;
